...
async function estimatePreRelay(request) {
    ...
    return Promise.all([
        ...
        const transactionFee = parseInt(ethers$1.utils.formatUnits(gasLimit, 'wei')) * parseFloat(ethers$1.utils.formatEther(gasPrice));
...
async function preRelay(signer, request) {
    ...
    try {
        ...
        const tokenContract = new ethers$1.Contract(tokenContractAddress, tokenContractABI, signer);
...
async function handler(event) {
    ...
    const forwarder = new ethers$1.Contract(forwarderContractAddress, forwarderContractABI, signer);
