import {IonAvatar, IonIcon, IonLabel, IonSpinner, IonText} from '@ionic/react';
        ...
        <div className={styles.container}>
            <div className={styles.dataContainer}>
                ...
                <div className={`ellipsis ${styles.startSlot}`}>
                    <div className={styles.id}>
                        <IonAvatar slot="start" className={styles.logo}>
                            <img alt=''
                                 src={loyaltyProgram.currency.programLogo ? loyaltyProgram.currency.programLogo : "assets/image/image-placeholder.svg"}/>
                        </IonAvatar>
                        <div className={styles.mainInfo}>
                            <IonLabel color='light'>
                                <PrimaryTypography color='light' isBlock={false} isBold
                                                   size='m'>{loyaltyProgram.currency.loyaltyCurrencyName}</PrimaryTypography>
                            </IonLabel>
                                    ...
                                    isLoadingMembership ?
                                        ...
                                        membership ?
                                            <>
                                                ...
                                                <PrimaryTypography color='success' customClassName='ellipsis'
                                                                   size='m'>Connected</PrimaryTypography>
                                            </>
                                            :
                                            <>
                                                <IonIcon icon={ellipse} color="danger"/>
                                                <PrimaryTypography color='danger' customClassName='ellipsis'
                                                                   size='m'>Disconnected</PrimaryTypography>
                                            </>
                                }
                            </IonLabel>
                        </div>
                    ...
                    <div className={styles.detailWrapper}>
                        <IonLabel className={styles.balanceRow}>
                            ...
                            <PrimaryTypography color='light' customClassName='ellipsis'
                                               size='m'>{membership?.balance} Units</PrimaryTypography>
                        </IonLabel>
                ...
                <div>
                    {
                        loyaltyProgram.redemption &&
                        <div className={styles.spinAction}
                             onClick={loyaltyProgram.redemption?.isSufficient ? spin : () => {
                             }}>
                            <div className={styles.actionItem}>
                                {loyaltyProgram.redemption?.isSufficient ?
                                    ...
                                    <>
                                        ...
                                        <PrimaryTypography isBlock={false} color='slightly-light'>Not enough
                                            credits</PrimaryTypography>
                                    </>
                                }
                            </div>
                        </div>
